...
public class ScreenUtils extends AbstractGui {
    ...
    @Deprecated
    public static final ResourceLocation BACKGROUND = new ResourceLocation(Eco.MOD_ID, "textures/gui/gui_default_background.png");
    @Deprecated
    public static final ResourceLocation FRAME = new ResourceLocation(Eco.MOD_ID, "textures/gui/gui_default_frame.png");
    @Deprecated
    public static final ResourceLocation GUI_BAR = new ResourceLocation(Eco.MOD_ID, "textures/gui/gui_bar.png");
    @Deprecated
    public static final ResourceLocation BUTTONS = new ResourceLocation(Eco.MOD_ID, "textures/gui/gui_button.png");


    public static final ResourceLocation INVENTORY = new ResourceLocation(Eco.MOD_ID, "textures/gui/inventory_configuration.png");
    ...
    public void renderNetwork(MatrixStack matrixStack, String name, int color, int x, int y) {
        ...
        Minecraft.getInstance().getTextureManager().bind(GUI_BAR);
        blit(matrixStack, x, y, 0, 0, 135, 12, 256, 256);
        Minecraft.getInstance().font.draw(matrixStack, name, x + 4, y + 2, 0xffffff);
    }
    ...
    public void drawHoverTooltip(MatrixStack matrixStack, List<String> strings, int x, int y) {
        ...
        for (String s : strings) {
            maxLength = Math.max(font.width(s), maxLength);
        }
        drawRectWithBackground(matrixStack, x, y, strings.size() * 9 + 3, maxLength + 4, 0x80ffffff, 0xc0000000);
        for (int i = 0; i < strings.size(); i++) {
            font.draw(matrixStack, strings.get(i), x + 2, y + 2 + 9 * i, 0xffffff);
        }
    }
