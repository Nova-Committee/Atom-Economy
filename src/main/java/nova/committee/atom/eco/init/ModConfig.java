...
public class ModConfig {
    ...
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            partialAccountNameSearch = builder.comment("true,可以通过输入玩家名来搜索帐户/false,则需要uuid").define("partial_account_name_search", true);
    ...
    public static class SyncableConfig {
        ...
        public static SyncableConfig fromNBT(CompoundTag compound) {
