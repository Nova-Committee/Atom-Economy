...
public abstract class IconData {
    public static IconData of(ItemLike item) {
        return of(new ItemStack(item));
    }

    public static IconData of(ItemStack iconStack) {
        return new ItemIcon(iconStack);
    }

    public static IconData of(ResourceLocation iconImage, int u, int v) {
        return new ImageIcon(iconImage, u, v);
    }

    public static IconData of(Component iconText) {
        return new TextIcon(iconText, 0xFFFFFF);
    }

    public static IconData of(Component iconText, int textColor) {
    ...
    private static class ItemIcon extends IconData {
        ...
        private ItemIcon(ItemStack iconStack) {
            this.iconStack = iconStack;
        }

        @Override
        public void render(PoseStack matrixStack, AbstractWidget widget, Font font, int x, int y) {
            ScreenUtil.drawItemStack(widget, font, this.iconStack, x, y);
        }
